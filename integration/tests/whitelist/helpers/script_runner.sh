...
mint_authority_json_file="../external/evm_loader_keypair.json"
...
../external/set_single_acct_permission.sh solana_url evm_loader_id mint_authority_json_file $1 $2 neon_eth_address
